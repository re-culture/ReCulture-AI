...
def get_exhibition_reviews():
    url = "https://ticket.interpark.com/Community/Play/Talk/CommunityList.asp?pageno=1&bbsno=44&stext=&sflag=&datetype=1"
    ...
    try:
        driver.execute_script("javascript:ChangeCategory('01008');")
        time.sleep(2)
        all_rows = []
...
reviews = get_exhibition_reviews()
print(f"Fetched {len(reviews)} reviews")

# 파일 저장
csv_filename = "exhibition_reviews.csv"
